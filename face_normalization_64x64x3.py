...
class face_normalization():
    """人脸的归一化为64x64x3 per picture's face shape is (64,64,3)"""
    def __init__(self):
        pass
    def dection(self):
        ...
        images = self.load_and_align_data(img_path_set, 64, 44)
...
if __name__=="__main__":
    t=face_normalization()#创建face_normalization
    t.dection()#调用检测并且归一化人脸的图片的大小为(64,64,3)